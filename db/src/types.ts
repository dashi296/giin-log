...
type ViewColumns<T> = {
  [K in keyof T as T[K] extends Column ? K : never]: T[K] extends Column ? T[K] : never;
};
export type CouncilorStats = InferModelFromColumns<
  ViewColumns<typeof councilorStats>
>;
